...
import { GetStarted, Splash, Register, Login, UploadPhoto, Doctor, Messages, Hospitals, ChooseDoctor, Chatting, UserProfile, UpdateProfile } from '../pages';
...
const MainApp = () => {
  return (
    <Tab.Navigator tabBar={props => <BottomNavigator {...props}/>}>
      ...
      <Tab.Screen name="Hospitals" component={Hospitals}></Tab.Screen>
    </Tab.Navigator>
  )
}
